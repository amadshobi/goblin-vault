...
## Struktur Direktori
Semua logika utama `ocm` berada di folder `tools-cli/src/ocm/`:
...
1. Buka file [menu.js](../src/ocm/ui/menu.js).
...
1. Buka file [utils.js](../src/ocm/utils.js).
...
Spinner monyet (`🙈 🙉 🙊`) dengan delay 300ms otomatis (untuk menghindari flicker pada tugas instan) di-export dari [spinner.js](../src/ocm/ui/spinner.js).
...
1. Buka file [spinner.js](../src/ocm/ui/spinner.js).
